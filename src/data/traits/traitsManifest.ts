export const traitsManifest = [
    ...
    { value: "blessed (Various)", label: "Blessed (Various)" },
    ...
    { value: "corruption (Strength)", label: "Corruption (Strength)" },
    ...
    { value: "fear (Rating)", label: "Fear (Rating)" },
    { value: "flight (Rating)", label: "Flight (Rating)" },
    ...
    { value: "magic Resistance (Rating", label: "Magic Resistance (Rating)" },
    { value: "ental Corruption", label: "Mental Corruption" },
    { value: "miracles (various)", label: "Miracles (various)" },
